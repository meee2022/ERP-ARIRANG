...
export const translations = {
  ...
  lpo:                { ar: "طلبات التوريد",        en: "Purchase Orders" },
  lpoTitle:           { ar: "طلب توريد محلي",        en: "Local Purchase Order" },
  newLPO:             { ar: "طلب توريد جديد",       en: "New LPO" },
  lpoNo:              { ar: "رقم الطلب",             en: "LPO No." },
  expectedDate:       { ar: "تاريخ التسليم المتوقع", en: "Expected Date" },
  markAsSent:         { ar: "تحديد كمرسل",           en: "Mark as Sent" },
  sentStatus:         { ar: "مرسل",                  en: "Sent" },
  partiallyReceived:  { ar: "مستلم جزئياً",         en: "Partially Received" },
  fullyReceived:      { ar: "مستلم بالكامل",        en: "Fully Received" },
  remainingQty:       { ar: "المتبقي",               en: "Remaining" },
  receivedQty:        { ar: "المستلم",               en: "Received" },
  orderedQty:         { ar: "المطلوب",               en: "Ordered" },
  shareWhatsApp:      { ar: "واتساب",                en: "WhatsApp" },
  shareEmail:         { ar: "بريد إلكتروني",        en: "Email" },
  printLPO:           { ar: "طباعة الطلب",           en: "Print LPO" },
  createGRNFromLPO:   { ar: "إنشاء استلام",         en: "Create GRN" },
  lpoLines:           { ar: "أصناف الطلب",          en: "Order Lines" },
  pendingLPOsBadge:   { ar: "طلبات بانتظار الإرسال", en: "Pending dispatch" },
  // ─── Sales Rep Commission ────────────────────────────────────────
  salesRepCommission: { ar: "عمولات المندوبين", en: "Rep Commissions" },
  // ─── Stock Take ──────────────────────────────────────────────────
  stockTake:           { ar: "الجرد الشهري",        en: "Monthly Stock Take" },
  stockTakeTitle:      { ar: "جرد المخزون",         en: "Stock Take" },
  newStockTake:        { ar: "جرد جديد",            en: "New Stock Take" },
  takeNumber:          { ar: "رقم الجرد",           en: "Take #" },
  takeDate:            { ar: "تاريخ الجرد",         en: "Take Date" },
  systemQty:           { ar: "رصيد النظام",         en: "System Qty" },
  physicalQty:         { ar: "العد الفعلي",         en: "Physical Count" },
  variance:            { ar: "الفرق",                en: "Variance" },
  varianceValue:       { ar: "قيمة الفرق",          en: "Variance Value" },
  shortage:            { ar: "نقص",                  en: "Shortage" },
  excess:              { ar: "زيادة",                en: "Excess" },
  notCounted:          { ar: "لم يُعد",              en: "Not Counted" },
  submitForReview:     { ar: "إرسال للمراجعة",      en: "Submit for Review" },
  approveAndAdjust:    { ar: "اعتماد وتسوية",       en: "Approve & Adjust" },
  approveOnly:         { ar: "اعتماد فقط",          en: "Approve Only" },
  rejectStockTake:     { ar: "رفض الجرد",           en: "Reject" },
  pendingReview:       { ar: "بانتظار المراجعة",    en: "Pending Review" },
  reasonWastage:       { ar: "هدر",                  en: "Wastage" },
  reasonTheft:         { ar: "سرقة محتملة",         en: "Theft" },
  reasonDamaged:       { ar: "تالف",                 en: "Damaged" },
  reasonProductionLoss:{ ar: "خسائر إنتاج",         en: "Production Loss" },
  reasonCountingError: { ar: "خطأ في العد",         en: "Counting Error" },
  reasonOther:         { ar: "أخرى",                 en: "Other" },
  ...
  productionMyRequests:     { ar: "طلبات المناديب",      en: "Sales-Rep Requests" },
  productionDailyPlan:      { ar: "خطة الإنتاج اليومية", en: "Daily Production Plan" },
  productionPlans:          { ar: "سجل خطط الإنتاج",     en: "Production Plans" },
