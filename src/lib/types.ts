...
export interface SalesInvoice {
  ...
  taxableAmount: number; // * 100
  vatAmount: number; // * 100
  serviceCharge: number; // * 100
  totalAmount: number; // * 100
  cashReceived: number; // * 100
  cardReceived: number; // * 100
...
export interface SalesInvoiceLine {
  ...
  vatRate: number;
  vatAmount: number; // * 100
  lineTotal: number; // * 100
  unitCost: number; // * 100
  costTotal: number; // * 100
  revenueAccountId?: string;
  cogsAccountId?: string;
  costCenterId?: string;
  warehouseId?: string;
...
export interface JournalEntry {
  ...
  sourceId?: string;
  description: string;
  totalDebit: number; // * 100
  totalCredit: number; // * 100
...
export interface SalesInvoiceLineInput {
  ...
  quantity: number;
  uomId: string;
  unitPrice: number; // displayed value (not * 100)
  discountPct: number;
