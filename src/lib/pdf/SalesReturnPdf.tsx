...
import { base, BRAND } from "./pdfStyles";
import {
...
const S = StyleSheet.create({
  ...
  reasonLabel: { fontSize: 8, color: "#166534", marginBottom: 2 },
  reasonValue: { fontSize: 9, color: "#15803d" },
});
...
export interface SalesReturnPdfData {
  ...
  isRTL: boolean;
  labels: {
    title: string; billTo: string; date: string;
...
export function SalesReturnPdf({ data }: { data: SalesReturnPdfData }) {
