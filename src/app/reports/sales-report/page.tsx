...
import { TrendingUp, Calendar, FileText, Printer, FileSpreadsheet, ChevronDown, ChevronUp, ExternalLink, X } from "lucide-react";
...
export default function SalesReportPage() {
  ...
  // Column counts per groupBy for colSpan
  const colCount = groupBy === "salesRep" ? 6 : groupBy === "day" ? 3 : 3;
          ...
          actions={
            <div className="flex items-center gap-2">
              <button
                ...
                className="h-9 px-3 rounded-lg inline-flex items-center gap-2 text-sm font-semibold border border-gray-200 bg-white text-gray-600 hover:bg-gray-50"
              >
            ...
            <table className="data-table">
              ...
              <tbody>
                {report.data.map((row: any, i: number) => {
                  // Determine row key for expand tracking
