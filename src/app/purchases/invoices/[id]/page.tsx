    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-[color:var(--ink-100)] p-8 print:shadow-none print:border-none print:rounded-none print:p-6" dir={isRTL ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div>
            <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-1">{t("supplier")}</p>
            <p className="font-semibold text-gray-900">{supplierName}</p>
          </div>
          <div className="flex justify-end items-start"><StatusBadge status={inv.postingStatus} type="posting" /></div>
        </div>
